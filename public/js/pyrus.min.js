...
Pyrus = function( e = null, dataPYRUS = null , urlFile = null) {
    ...
    this.inputString = function(OBJ_elemento,STR_nombre,STR_type,STR_class,OBJ_funcion = null, placeholder = "", multiple = null) {
        ...
        if(STR_type == "file") {
            ...
            if(OBJ_elemento.SIMPLE === undefined) {
                w = "auto";
                if(OBJ_elemento.WIDTH !== undefined)
                    w = OBJ_elemento.WIDTH;
                input = `<img id="src-${STR_id}" class="w-100 mx-auto d-block mb-1 img-thumbnail" style="max-width: ${w};" src="" onError="this.src='${urlFile}'" /><div class="custom-file">${input}</div>`;
            } else {
