...
Pyrus = function( e = null, dataPYRUS = null , urlFile = null) {
    ...
    this.select = function(OBJ_elemento,STR_nombre,STR_class,OBJ_funcion,OBJ_datos = null,placeholder = null, multiple = null) {
        ...
        let return_STR = `<select ${(OBJ_elemento["MULTIPLE"] ? "multiple='true'" : "data-allow-clear='true'")} ${(OBJ_elemento.DISABLED ? "disabled='true'" : "")} ${(OBJ_elemento["NECESARIO"] ? "required='true'" : "")} ${STR_funcion} name="${name}" id="${STR_nombre}" class="${STR_class} select__2 w-100" style="width:100%;" data-tags="true" data-placeholder="${OBJ_elemento["NOMBRE"]}">`;
