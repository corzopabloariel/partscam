...
Pyrus = function( e = null, dataPYRUS = null , urlFile = null) {
            ...
            for(let e in row) {
                ...
                if(e == "BTN") {
                    ...
                    if(this.especificacion[e].TIPO == "TP_FILE") {
                        ...
                        aux = `<img id="src-${e}" class="w-100 mx-auto d-block bg-dark mb-1 img-thumbnail" src="" onError="this.src='${urlFile}'" /><div class="custom-file">${aux}</div>`;
                    }
    ...
    this.inputString = function(OBJ_elemento,STR_nombre,STR_type,STR_class,OBJ_funcion = null, placeholder = "", multiple = null) {
        ...
        input = `<input value="${OBJ_elemento.DEFAULT !== undefined ? OBJ_elemento.DEFAULT : ''}" ${inputData} name="${name}" id="${STR_nombre}" class="${STR_class}" type="${STR_type}" placeholder="${placeholder == "" ? OBJ_elemento["NOMBRE"] : placeholder}" />`;
    ...
    this.select = function(OBJ_elemento,STR_nombre,STR_class,OBJ_funcion,OBJ_datos = null,placeholder = null, multiple = null) {
        ...
        let return_STR = `<select ${(OBJ_elemento["MULTIPLE"] ? "multiple='true'" : "data-allow-clear='true'")} ${(OBJ_elemento["DISABLED"] ? "disabled='true'" : "")} ${(OBJ_elemento["NECESARIO"] ? "required='true'" : "")} ${STR_funcion} name="${name}" id="${STR_nombre}" class="${STR_class} select__2" data-placeholder="${OBJ_elemento["NOMBRE"]}">`;
